...
export type ICommonModal = {
    children: ReactNode;
    isFooter: boolean;
} & IFooterModal & IHeaderModal;

const withModal = (animationSettings: { from: any; to: any; close: any; containerClass: any; }) => {
    return ({
        children,
        title = "",
        onClose = () => { },
        ...
        useEffect(() => {
            gsap.fromTo(modalRef.current, animationSettings.from, animationSettings.to);
        }, []);
        ...
        return (
            <dialog
                ...
                onClose={handleClose}
            >
                <div className={`modal-container bg-white rounded-lg shadow dark:bg-gray-700 dark:text-white ${animationSettings.containerClass}`} ref={modalRef}>
